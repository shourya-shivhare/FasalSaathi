...
def create_production_registry() -> ToolRegistry:
    ...
    from ai_service.app.tools import weather_client as wc
    from ai_service.app.tools import agmarknet_client as mc
    from ai_service.app.tools import scheme_db as sdb
    from ai_service.app.tools import trend_analysis as ta
    from ai_service.app.tools import forecasting as fc
    from ai_service.app.tools import pest_map as pm
    from ai_service.app.tools import memory_tools as mt
    from ai_service.app.storage.image_store import ImageStore
    from ai_service.app.memory.store import SQLiteMemoryStore
